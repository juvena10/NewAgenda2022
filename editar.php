...
<div class="sidebar">
  ...
  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <div class="info">
      <a href="#" class="d-block">Kauan Queiroz</a>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="card card-primary">
          ...
          <?php
              ...
              if(isset($_POST['btnCContato'])){
                  ...
                  $extensao = pathinfo($_FILES['foto']['name'], PATHINFO_EXTENSION);//$extensao  = extrai a extensão do arquivo
 
                  if(in_array($extensao, $formatP)){
                      $pasta = "img/contato/"; //pasta que recebe a imagem de upload
      ...
      <div class="col-md-7">
        <div class="card card-primary">
          ...
          <img style="width:200px; border-radius:100%" src="img/contato/">
          <h1>Kauan Queiroz</h1>
          <h2>(85)4444-5555</h2>
          <h3 style="margin: 0 auto; margin-bottom:30px; width:150px; border-radius:80px">kauan@gmail.com</h3>

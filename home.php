            ...
            <div class="card card-primary">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  <button name="btCContato" type="submit" class="btn btn-primary">Cadastrar Contato</button>
                </div>
              </form>
              <?php
                  ...
                  if(isset($_POST['btnCContato'])){
                      ...
                      // $extensao = extrai a extensão do nome do arquivo
            ...
            <div class="card card-primary">
              ...
              <div class="card-body p-0">
                <table class="table table-sm">
                  ...
                  <tbody>
                    <?php
                      $select = "SELECT * FROM tdContato ORDER BY idContato DESC LIMIT 8";
                      try{

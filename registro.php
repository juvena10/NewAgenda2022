    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-6">
            <button name="btnUsuario" type="submit" class="btn btn-primary btn-block">Registrar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      <?php
                 ...
                 if(isset($_POST['btnUsuario'])){
                     ...
                     $cadastro = "INSERT INTO tb_user(nome_user, senha_user, email_user, foto_user) VALUES (:nome, :senha, :email, :foto)";
                     try{
